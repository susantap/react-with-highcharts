 ...
 */
export const constructChartConfigs = (chartType, additionalConfig) => {


    if (!chartType || !chartTypeCostants[chartType] || !CHART_CONFIGS[chartType]) {
        //TODO: This strings need to be localized
        throw new Error(chartType + ' :The provided Chart type is not Valid');

    } else {
        return Highcharts.merge(CHART_CONFIGS[chartType], additionalConfig)
    }
